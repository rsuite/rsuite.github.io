...
React Suite 支持最新的，稳定版的全部主流浏览器。

- 我们对 IE10 提供有限度的支持，部分样式和动画在 IE10 下的表现会有所简化。对于 IE 系列浏览器，需要提供使用 Polyfill 进行支持，我们建议您使用 [babel-preset-env][babel-preset-env] 来处理浏览器的兼容性问题。
